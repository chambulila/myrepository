...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">{{ __('Suppliers') }}
                </div>
                <div class="card-body">
                    <a href="{{ route('supplier.create') }}" class="btn btn-primary float-right m-2"> Add Supplier</a>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button type="button" onclick="onDeleteInfo('{{$supplier->id}}')" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteModel">Delete</button>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
